...
public class Nodo {
    /* -- ATTRIBUTI -- */ 
    private String stazione;                    //Identificativo stazione
    private String ieri;                        //Stringa contenente il path relativo del file di ieri
    private String altroieri;                   //Stringa contenente il path relativo del file dell' altroieri
    private Nodo nextList;                      //puntatore a nodo successivo nella lista principale
    private Nodo nextSublist;                   //puntatore a nodo successivo nella sottolista*/
